...
function exp_BikeFeat_1rule0_eval_expression(context) {
    // Pump LIKE '%Gauge ONLY'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Pump').indexOf('Gauge ONLY') > -1);
    } else {
        return (feature.get('Pump').indexOf('Gauge ONLY') > -1);
    }
}
...
function exp_BikeFeat_1rule1_eval_expression(context) {
    // FixItSta = 'Yes' AND Pump = 'No'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('FixItSta')  == 'Yes') && (feature.get('Pump')  == 'No'));
    } else {
        return ((feature.get('FixItSta')  == 'Yes') && (feature.get('Pump')  == 'No'));
    }
}
...
function exp_BikeFeat_1rule2_eval_expression(context) {
    // FixItSta = 'Yes' AND Pump LIKE '%Gauge'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('FixItSta')  == 'Yes') && (feature.get('Pump').indexOf('Gauge') > -1));
    } else {
        return ((feature.get('FixItSta')  == 'Yes') && (feature.get('Pump').indexOf('Gauge') > -1));
    }
}
...
function exp_BikeFeat_1rule3_eval_expression(context) {
    // FixItSta = 'Yes' AND Pump = 'Air Comp'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('FixItSta')  == 'Yes') && (feature.get('Pump')  == 'Air Comp'));
    } else {
        return ((feature.get('FixItSta')  == 'Yes') && (feature.get('Pump')  == 'Air Comp'));
    }
}
...
function exp_BikeFeat_1rule5_eval_expression(context) {
    // Pump LIKE '%Comp ONLY'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Pump').indexOf('Comp ONLY') > -1);
    } else {
        return (feature.get('Pump').indexOf('Comp ONLY') > -1);
    }
}